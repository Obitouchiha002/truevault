 ...
 * Phase 5; until then the screen states plainly that the step is not available rather than
...
fun PrivateAppsScreen(
    ...
    Column(
        ...
        TvSectionHeader(title = stringResource(R.string.private_apps_title))
        TvBanner(
            text = stringResource(R.string.private_apps_pending),
