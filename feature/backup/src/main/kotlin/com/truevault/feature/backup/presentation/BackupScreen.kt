 ...
 * Phase 4; until then the screen states plainly that the step is not available rather than
...
fun BackupScreen(
    ...
    Column(
        ...
        TvSectionHeader(title = stringResource(R.string.backup_title))
        TvBanner(
            text = stringResource(R.string.backup_pending),
